            ...
            <div className="flex items-center gap-2">
              {sheetUrl ? (
                <a href={sheetUrl} target="_blank" rel="noopener noreferrer"
                  title="Open in Google Sheets (view only)"
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold bg-emerald-50 dark:bg-emerald-900/20 text-emerald-700 dark:text-emerald-400 hover:bg-emerald-100 dark:hover:bg-emerald-900/40 border border-emerald-200 dark:border-emerald-800 transition-colors">
                  <ExternalLink size={12} /> Open in Sheets
                </a>
              ) : (
                <span title="Set VITE_GOOGLE_SHEET_URL in your .env to enable this" className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold bg-slate-100 dark:bg-gray-800 text-slate-400 border border-slate-200 dark:border-gray-700 cursor-help">
                  <ExternalLink size={12} /> Open in Sheets
                </span>
              )}
              {dataRowCount > 0 && (
