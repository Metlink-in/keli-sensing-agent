...
export default function SettingsPage() {
  ...
  const ENV_GROUPS = [
    ...
    { title: "Google Sheets", keys: ["GOOGLE_SERVICE_ACCOUNT_EMAIL", "GOOGLE_PRIVATE_KEY", "GOOGLE_SHEETS_SPREADSHEET_ID"] },
  ];
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 pb-12">
            ...
            {ENV_GROUPS.map((group, idx) => (
              <div key={idx} className="space-y-4">
                ...
                <div className="grid grid-cols-1 gap-4 bg-slate-50 dark:bg-gray-900/40 p-5 rounded-2xl border border-slate-100 dark:border-gray-800">
                  {group.keys.map(key => {
                    const isMultiline = key === "GOOGLE_PRIVATE_KEY";
                    ...
                    return (
                      <div key={key}>
                        ...
                        <div className="relative">
                          {isMultiline ? (
                            <textarea 
                              className="input font-mono text-xs w-full min-h-[100px]"
                              value={envData[key] || ""}
      ...
      <div className="glass-card p-6">
        ...
        <p className="text-sm text-slate-500 mb-6">Manage global configuration for the Keli agent.</p>
